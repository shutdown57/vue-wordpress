        ...
        infiniteHandler($state) {
            ...
            this.$http.get("http://wordpress.app/wp-json/wp/v2/posts", {
                ...
                if (res.body.length) {
                    ...
                    this.productSubscribCard = this.productSubscribCard.concat(res.body);
                    console.log(this.productSubscribCard);
                    $state.loaded();
                    if (this.productSubscribCard.length % 10 === 0) {
                        $state.complete();
                    }
                } else {
                    $state.complete();
