...
export const PRODUCT_RELIGION = 'PRODUCT_RELIGION';
export const PRODUCT_ONCAR = 'PRODUCT_ONCAR';
export const PRODUCT_MARKER = 'PRODUCT_MARKER';
export const PRODUCT_PICTURE_FRAME = 'PRODUCT_PICTURE_FRAME';
export const PRODUCT_CARD_SUBSCRIBE = 'PRODUCT_CARD_SUBSCRIBE';
export const PRODUCT_CARD_VISIT = 'PRODUCT_CARD_VISIT';
