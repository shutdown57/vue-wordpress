...
export const PRODUCT_ONCAR = [];
export const PRODUCT_MARKER = [];
export const PRODUCT_PICTURE_FRAME = [];
export const PRODUCT_CARD_SUBSCRIBE = [];
export const PRODUCT_CARD_VISIT = [];